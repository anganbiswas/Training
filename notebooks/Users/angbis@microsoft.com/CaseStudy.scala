...
val defaultMoviesUrl = "https://anganstorage.blob.core.windows.net/data/movies.csv"
val defaultRatingsUrl = "adl://angandatalakestore.azuredatalakestore.net/data/ratings.csv"
...
spark.conf.set("dfs.adls.oauth2.client.id", "ebef0449-d08a-4136-a16c-2180bc4ac8bf")
spark.conf.set("dfs.adls.oauth2.credential", "qvD3rH2KoAXOHFQCkT9CAvDy+AdP/NFLgPZ8MxX6MF8=")
